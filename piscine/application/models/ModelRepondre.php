...
abstract class ModelRepondre 
{
    ...
    public static function sum_reading($codeINE, $idToeic) {
        $requete = "SELECT sum(score), `date` FROM repondre WHERE codeINE = :codeINE_tag AND idToeic = :idToeic_tag AND IdPartie = '5' OR codeINE = :codeINE_tag AND idToeic = :idToeic_tag AND IdPartie = '6' OR codeINE = :codeINE_tag AND idToeic = :idToeic_tag AND IdPartie = '7' GROUP BY codeINE, `date`, idToeic";
    ...
    public static function sum_listening($codeINE, $idToeic) {
        $requete = "SELECT sum(score) FROM repondre WHERE codeINE = :codeINE_tag AND idToeic = :idToeic_tag AND IdPartie = '1' OR codeINE = :codeINE_tag AND idToeic = :idToeic_tag AND IdPartie = '2' OR codeINE = :codeINE_tag AND idToeic = :idToeic_tag AND IdPartie = '3' OR codeINE = :codeINE_tag AND idToeic = :idToeic_tag AND IdPartie = '4' GROUP BY `date`";
